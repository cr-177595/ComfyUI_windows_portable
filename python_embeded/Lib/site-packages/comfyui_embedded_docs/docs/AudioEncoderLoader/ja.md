...
| パラメータ | 説明 | データ型 | 必須 | 範囲 |
| --- | --- | --- | --- | --- |
| `オーディオエンコーダー名` | 読み込むオーディオエンコーダーモデルファイルを選択します | STRING | はい | audio_encoders フォルダ内の利用可能なオーディオエンコーダーファイルの一覧 |

## 出力

| 出力名 | 説明 | データ型 |
| --- | --- | --- |
| `audio_encoder` | 読み込まれたオーディオエンコーダーモデル。オーディオ処理ワークフローで使用する準備が整っています | AUDIO_ENCODER |
