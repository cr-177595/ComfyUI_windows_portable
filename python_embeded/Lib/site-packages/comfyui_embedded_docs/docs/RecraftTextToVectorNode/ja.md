...
| `ネガティブプロンプト` | 画像内の望ましくない要素に関するオプションのテキスト説明。（デフォルト：""） | STRING | いいえ | - |
| `Recraft コントロール` | Recraft Controlsノードを介した生成に対するオプションの追加制御。 | CONTROLS | いいえ | - |
