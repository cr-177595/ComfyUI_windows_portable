...
| パラメータ | 説明 | データ型 | 必須 | 範囲 |
| --- | --- | --- | --- | --- |
| `テンプレート` | PixVerse 動画生成に使用するテンプレートです。利用可能なオプションは、PixVerse システム内の定義済みテンプレートに対応しています。 | STRING | はい | 複数のオプションが利用可能 |

## 出力

| 出力名 | 説明 | データ型 |
| --- | --- | --- |
| `pixverse_template` | 選択したテンプレート名に対応するテンプレート ID です。他の PixVerse ノードで動画生成に使用できます。 | STRING |
