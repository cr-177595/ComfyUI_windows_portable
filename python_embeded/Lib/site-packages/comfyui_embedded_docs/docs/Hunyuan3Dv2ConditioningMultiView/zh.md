...
| 参数 | 描述 | 数据类型 | 是否必需 | 范围 |
| --- | --- | --- | --- | --- |
| `前` | 正面视角的 CLIP 视觉输出 | CLIP_VISION_OUTPUT | 否 | - |
| `左` | 左侧视角的 CLIP 视觉输出 | CLIP_VISION_OUTPUT | 否 | - |
| `后` | 背面视角的 CLIP 视觉输出 | CLIP_VISION_OUTPUT | 否 | - |
| `右` | 右侧视角的 CLIP 视觉输出 | CLIP_VISION_OUTPUT | 否 | - |
