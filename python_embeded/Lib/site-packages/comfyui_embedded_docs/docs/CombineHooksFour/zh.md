...
| --- | --- | --- | --- | --- | --- |
| `hooks_A` | 要组合的第一个钩子组 | HOOKS | 可选 | None | - |
| `hooks_B` | 要组合的第二个钩子组 | HOOKS | 可选 | None | - |
| `hooks_C` | 要组合的第三个钩子组 | HOOKS | 可选 | None | - |
| `hooks_D` | 要组合的第四个钩子组 | HOOKS | 可选 | None | - |
