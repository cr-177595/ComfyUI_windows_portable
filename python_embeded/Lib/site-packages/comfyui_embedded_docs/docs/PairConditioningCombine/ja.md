...
| パラメータ | 説明 | データ型 | 必須 | 範囲 |
| --- | --- | --- | --- | --- |
| `ポジティブ_A` | 1つ目のポジティブコンディショニング入力 | CONDITIONING | はい | - |
| `ネガティブ_A` | 1つ目のネガティブコンディショニング入力 | CONDITIONING | はい | - |
| `ポジティブ_B` | 2つ目のポジティブコンディショニング入力 | CONDITIONING | はい | - |
| `ネガティブ_B` | 2つ目のネガティブコンディショニング入力 | CONDITIONING | はい | - |
