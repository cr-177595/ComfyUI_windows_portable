...
| --- | --- | --- | --- | --- |
| `视频` | 用于唇形同步的输入视频文件 | VIDEO | 是 | - |
| `文本` | 唇形同步视频生成的文本内容。当模式为 text2video 时必填。最大长度为120个字符。 | STRING | 是 | - |
| `语音` | 唇形同步音频的语音选择（默认值："Melody"） | COMBO | 否 | "Melody"<br>"Bella"<br>"Aria"<br>"Ethan"<br>"Ryan"<br>"Dorothy"<br>"Nathan"<br>"Lily"<br>"Aaron"<br>"Emma"<br>"Grace"<br>"Henry"<br>"Isabella"<br>"James"<br>"Katherine"<br>"Liam"<br>"Mia"<br>"Noah"<br>"Olivia"<br>"Sophia" |
| `语速` | 语速。有效范围：0.8~2.0，精确到一位小数。（默认值：1） | FLOAT | 否 | 0.8-2.0 |
