...
| パラメータ | 説明 | データ型 | 必須 | 範囲 |
| --- | --- | --- | --- | --- |
| `オーディオ1` | 連結される最初のオーディオ入力 | AUDIO | はい | - |
| `オーディオ2` | 連結される2番目のオーディオ入力 | AUDIO | はい | - |
| `方向` | audio2をaudio1の後に追加するか、前に追加するかを指定します（デフォルト："after"） | COMBO | はい | `"after"`<br>`"before"` |

## 出力

| 出力名 | 説明 | データ型 |
| --- | --- | --- |
| `AUDIO` | 両方の入力オーディオファイルが連結された結合オーディオ | AUDIO |
