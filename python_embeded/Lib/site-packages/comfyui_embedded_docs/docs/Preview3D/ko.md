...
**3D 노드 환경 설정**
3D 노드에 대한 일부 관련 환경 설정은 ComfyUI의 설정 메뉴에서 구성할 수 있습니다. 해당 설정에 대해서는 다음 문서를 참조하십시오:
...
미리보기 영역에는 일부 뷰 조작 메뉴가 메뉴 안에 숨겨져 있습니다. 메뉴 버튼을 클릭하여 다양한 메뉴를 펼칠 수 있습니다.
...
2. **재질 모드**: 모델 렌더링 모드 전환 - 원본, 법선, 와이어프레임, 라인아트
...
이 메뉴는 직교 뷰와 원근 뷰 간 전환 및 원근 각도 크기 설정을 제공합니다:
