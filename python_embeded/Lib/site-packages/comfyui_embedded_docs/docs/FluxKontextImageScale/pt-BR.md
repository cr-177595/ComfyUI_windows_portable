...
A seguir está uma lista de tamanhos padrão utilizados durante o treinamento do modelo. O nó selecionará o tamanho mais próximo da proporção de aspecto da imagem de entrada:
