...
| パラメータ | 説明 | データ型 | 必須 | 範囲 |
| --- | --- | --- | --- | --- |
| `inputs` | バッチに結合する動的な入力リストです。1～50個のアイテムを追加できます。すべてのアイテムは同じタイプ（すべて画像、すべてマスク、またはすべて潜在表現）である必要があります。 | IMAGE、MASK、またはLATENT | はい | 1～50個の入力 |
...
| 出力名 | 説明 | データ型 |
| --- | --- | --- |
| `output` | 単一のバッチ出力です。データ型は入力タイプ（バッチ化されたIMAGE、バッチ化されたMASK、またはバッチ化されたLATENT）と一致します。 | IMAGE、MASK、またはLATENT |
