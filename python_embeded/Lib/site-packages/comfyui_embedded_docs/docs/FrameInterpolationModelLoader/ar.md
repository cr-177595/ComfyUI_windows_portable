...
تقوم هذه العقدة بتحميل نموذج استيفاء الإطارات (Frame Interpolation) من ملف وتهيئته للاستخدام في سير العمل. تقوم العقدة تلقائيًا باكتشاف نوع النموذج (FILM أو RIFE) وتكوينه لتحقيق الأداء الأمثل على جهازك.

## المدخلات

| المعامل | الوصف | نوع البيانات | إلزامي | النطاق |
| --- | --- | --- | --- | --- |
| `اسم النموذج` | حدد نموذج استيفاء الإطارات لتحميله. يجب وضع النماذج في مجلد 'frame_interpolation'. | STRING | نعم | قائمة ملفات النماذج في مجلد `frame_interpolation` |

## المخرجات

| اسم المخرج | الوصف | نوع البيانات |
| --- | --- | --- |
| `FRAME_INTERPOLATION_MODEL` | النموذج المحمّل والمهيأ لاستيفاء الإطارات، جاهز للاستخدام في العقد الأخرى. | MODEL |
