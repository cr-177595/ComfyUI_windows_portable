...
| --- | --- | --- | --- | --- |
| `model_name` | Select a frame interpolation model to load. Models must be placed in the 'frame_interpolation' folder. | STRING | Yes | List of model files in the `frame_interpolation` folder |

## Outputs

| Output Name | Description | Data Type |
| --- | --- | --- |
| `FRAME_INTERPOLATION_MODEL` | The loaded and configured frame interpolation model, ready for use in other nodes. | MODEL |
